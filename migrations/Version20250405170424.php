 ...
 */
final class Version20250405170424 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE employee_event_assignments (id INT AUTO_INCREMENT NOT NULL, employee_id INT NOT NULL, event_id INT NOT NULL, role VARCHAR(100) NOT NULL, status VARCHAR(50) DEFAULT \'Assigned\' NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_9D64DD7C8C03F15C (employee_id), INDEX IDX_9D64DD7C71F7E88B (event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE employee_event_assignments ADD CONSTRAINT FK_9D64DD7C8C03F15C FOREIGN KEY (employee_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE employee_event_assignments ADD CONSTRAINT FK_9D64DD7C71F7E88B FOREIGN KEY (event_id) REFERENCES evenement (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE employee_event_assignments DROP FOREIGN KEY FK_9D64DD7C8C03F15C');
        $this->addSql('ALTER TABLE employee_event_assignments DROP FOREIGN KEY FK_9D64DD7C71F7E88B');
        $this->addSql('ALTER TABLE evenement DROP FOREIGN KEY FK_B26681EA76ED395');
        $this->addSql('DROP TABLE demande_sponsoring');
        $this->addSql('DROP TABLE employee_event_assignments');
